...
class KeyboardControl(object):
    ...
    def __init__(self, world, start_in_autopilot):
        self.start_location = carla.Location(x=0, y=13, z=2.0)
        self.start_rotation = carla.Rotation(pitch=0.0, yaw=180, roll=0.0)
            ...
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    if self._autopilot_enabled == True :
                        self._autopilot_enabled = False
                        world.player.set_autopilot(self._autopilot_enabled)
                    world.hud.notification("Go To Start Point")
                    world.modify_vehicle_physics(world.player)
                    # world.player.set_location(self.start_location)
