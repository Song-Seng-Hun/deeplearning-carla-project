...
class myTracker :
    ...
    # def __del__(self) :       # make log file
        # try :
    ...
    def render(self, display):
        ...
        if self.image is not None:
            ...
            for box in boxes :
                ...
                if len(tracker_list) > 0 :
                    for tracker in tracker_list :
                        ...
                        if abs(tracker_center[0]-center[0])<W_THRES and abs(tracker_center[1]-center[1])<H_THRES or bbox[2]<W_THRES or bbox[3]<H_THRES :
            ...
            for i in range(len(tracker_list)) :
                ...
                if (success is False and bbox[2]<W_THRES/depth and bbox[3]<H_THRES/depth) or bbox[0]+bbox[2]<0 or bbox[0]>VIEW_WIDTH or bbox[1]+bbox[3]>VIEW_HEIGHT or bbox[1]<0 or bbox[2]<20 or bbox[3]<20 :
                    tracker_list.pop(i)
                    del tracker
                    i -= 1
