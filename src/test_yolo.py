...
class BasicSynchronousClient(object):
    ...
    def game_loop(self):
        ...
        try:
            ...
            # 140-10, 21-105, 52-104
            # self.slow_points = [self.spawn_points[140].location, self.spawn_points[21].location, self.spawn_points[52].location]
            # self.fast_points = [self.spawn_points[10].location, self.spawn_points[105].location, self.spawn_points[104].location]
            ...
            while True:
                ...
                # if self.car.get_location().distance(self.slow_points[0]) < 1:
                #     self.tm.vehicle_percentage_speed_difference(self.car, 80)
                # elif self.car.get_location().distance(self.slow_points[1]) < 1:
                #     self.tm.vehicle_percentage_speed_difference(self.car, 80)
                # elif self.car.get_location().distance(self.slow_points[2]) < 1:
                #     self.tm.vehicle_percentage_speed_difference(self.car, 80)
                # elif self.car.get_location().distance(self.fast_points[0]) < 1:
                #     self.tm.vehicle_percentage_speed_difference(self.car, 30)
                # elif self.car.get_location().distance(self.fast_points[1]) < 1:
                #     self.tm.vehicle_percentage_speed_difference(self.car, 30)
                # elif self.car.get_location().distance(self.fast_points[2]) < 1:
                #     self.tm.vehicle_percentage_speed_difference(self.car, 30)
